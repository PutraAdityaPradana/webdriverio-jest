...
const TYPE_HANDLERS = {
    name: (element, value) => element().selectByAttribute('name', value),
    value: (element, value) => element().selectByAttribute('value', value),
    text: (element, value) => element().selectByVisibleText(value),
};
 ...
 */
export default (type, value, element) => {
