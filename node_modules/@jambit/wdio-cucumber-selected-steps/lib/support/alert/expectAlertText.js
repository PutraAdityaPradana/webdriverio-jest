 ...
 */
export default (type, reverse, expectedText) => {
    try {
        ...
        if (reverse) {
            ...
            failMessage(() => expect(text).toBe(expectedText), `Expected the text of the ${dropFirstWord(type)} to equal "${expectedText}", instead found "${text}"`);
        }
    }
    catch (e) {
