 ...
 */
export default (name, reverse, expectedValue) => {
    ...
    if (reverse) {
        ...
        failMessage(() => expect(cookie.value).toBe(expectedValue), `expected cookie "${name}" to have value "${expectedValue}" but got "${cookie.value}"`);
    }
};
