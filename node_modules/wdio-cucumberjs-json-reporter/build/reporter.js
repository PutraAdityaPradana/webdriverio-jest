...
class CucumberJsJsonReporter extends _reporter.default {
  ...
  getFeatureDataObject(featureData, instanceMetadata) {
    ...
    return _objectSpread({
      ...
      description: _utils.default.escapeHTML(featureData.description || ''),
      line: parseInt(featureData.uid.substring(featureName.length, featureData.uid.length)),
      name: _utils.default.escapeHTML(featureName),
  ...
  getScenarioDataObject(scenarioData, id) {
    ...
    return {
      ...
      description: _utils.default.escapeHTML(scenarioData.description || ''),
      name: _utils.default.escapeHTML(scenarioName),
  ...
  getStepDataObject(stepData) {
    ...
    const stepResult = {
      ...
      keyword: keyword,
      name: _utils.default.escapeHTML(title),
