 ...
 */
export const ucFirst = (text) => text[0].toUpperCase() + text.substring(1);
/**
 * Remove the first word of the supplied string (including whitespace).
 * @param text  The text to change
 */
export const dropFirstWord = (text) => text.replace(FIRST_WORD_REGEX, '');
/**
 * Get the last element of a list
 * @param list  The list to use
 */
export const lastOf = (list) => list[list.length - 1];
/**
 * Get the current url or path (if type !== 'url')
 * @param type  The type
 */
export const getUrlOrPath = (type) => {
...
export const getText = global.selectedStepsTextMethod === 'textContent'
    ? (element) => element.getProperty('textContent').trim()
 ...
 */
export const getTextOrValue = (type, element) => {
    if (type !== 'button') {
